...
The parity-inferred forward matches Deribit's *own* published forward to **< 0.5%** across
all 24 expiries — an external check that the construction is sound. Full method and
...
| 1 month (0.06y) | 29.7 ± 0.0% | 42.3 ± 0.0% |
| 3 months (0.13y)| 31.5 ± 0.3% | 45.8 ± 0.1% |
| 6 months (0.38y)| 39.3 ± 0.1% | 53.1 ± 0.1% |
| 11 months (0.88y)| 42.1 ± 0.0% | 56.3 ± 0.3% |
...
pts** at the front to **−4.6 vol pts** at 6 months, then eases slightly at the longest tenor:
...
- **ETH carries a consistently higher butterfly than BTC** (roughly 1.0–1.7 vs 0.3–0.9 vol
  pts), i.e. fatter implied tails on both sides — coherent with ETH's higher overall vol.
- For both, BF₂₅ is largest at the ~3-month tenor (BTC 1.65, ETH 1.74 vol pts) and smaller at
  the front and the long end.
...
uniform downside skew that steepens to ~−4.6 vol pts by 6 months; ETH's skew *flips*, showing
