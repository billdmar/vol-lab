...
Small, dependency-light utilities that the lattice, Monte-Carlo, and LSMC engines all
need. Kept in one place so the definitions can't drift apart (they were previously
duplicated per engine while the ownership map was in force during the build).
"""
